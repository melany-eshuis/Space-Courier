...
function courierservice() {
  ...
  xhr.onreadystatechange = function () {
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      result.innerHTML = allStars[0].x +" "+ allStars[0].y +" "+ allStars[0].hex +" "+ allStars[0].r;
...
function initSpaceRaster() {
  ...
  // const stars = [ 
  //   {x: 9 , y: 11, r: 20, color: "#FFFFFF" },
  //   {x: 10 , y: 12, r: 20, color: "#FFFFFF"},
  //   {x: 11 , y: 13, r: 20, color: "red"},
  //   {x: 5 , y: 11, r: 20, color: "blue"},
  //   {x: 6 , y: 11.5, r: 20, color: "green"},
  //   {x: 7 , y: 12, r: 20, color: "red"}]

  // stars.forEach((star) => {
  //   drawStar(star, mapRatio);
  // })
